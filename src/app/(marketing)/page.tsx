                    ...
                    <div className="flex flex-col items-center space-y-8 text-center">
                        ...
                        <div className="space-y-4 max-w-4xl">
                            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl">
                                Turn more Shopify visitors into buyers
                                <span className="text-primary">
                                    {" "}
                                    — without adding ad spend
                                </span>
                            </h1>
                            <p className="mx-auto max-w-2xl text-xl text-muted-foreground sm:text-2xl">
                                We run lean CRO programs for $5k–$50k/mo stores.
                                Start with a free 12-point &quot;Sniff
                                Check&quot;.
                            </p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <Card className="text-center">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Optimize site speed and Core Web Vitals to
                                    reduce bounce rates and improve user
                                    experience.
                                </CardDescription>
                            </CardHeader>
                        </Card>
                        ...
                        <Card className="text-center">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Streamline navigation, checkout flow, and
                                    product pages to remove friction and boost
                                    conversions.
                                </CardDescription>
                            </CardHeader>
                        </Card>
                        ...
                        <Card className="text-center">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    ...
                                    changes and ensure every optimization drives
                                    real results.
                                </CardDescription>
                            </CardHeader>
                        </Card>
                ...
                <div className="container px-4 md:px-6">
                    <div className="flex flex-col items-center space-y-8 text-center bg-primary/5 rounded-2xl p-12">
                        <div className="space-y-4">
                            ...
                            <p className="max-w-2xl text-lg text-muted-foreground">
                                Start with our free Sniff Check. Get actionable
                                insights in 48 hours, no strings attached.
                            </p>
                        </div>
