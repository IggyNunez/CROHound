...
export default function ServicesPage() {
    return (
        <>
            {/* Structured Data */}
            <ServiceSchema serviceKey="audit" path="/services" />
            ...
            <div className="flex flex-col">
                ...
                <Hero
                    ...
                    description="Evidence-based conversion optimization services designed specifically for Shopify stores."
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                ...
                                <CardContent className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <p className="text-sm text-muted-foreground">
                                            <strong>Timeline:</strong> 3-5
                                            business days
                                        </p>
                                        <p className="text-sm text-muted-foreground">
                                            <strong>Deliverable:</strong>{" "}
                                            Detailed report + 30-min strategy
                                            call
                                        </p>
                                    </div>
                                </CardContent>
                            ...
                            <Card className="h-full">
                                <CardHeader>
                                    ...
                                    <CardDescription className="text-lg">
                                        Data-driven testing to validate changes
                                        and maximize conversion improvements.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-6">
                                    <div className="space-y-4">
                            ...
                            <Card className="h-full">
                                ...
                                <CardContent className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            <strong>Guarantee:</strong> Minimum
                                            20% improvement in page speed
                                        </p>
                                    </div>
                                </CardContent>
                            </Card>
                        ...
                        <div className="flex flex-col items-center space-y-12">
                            <div className="text-center space-y-4">
                                ...
                                <p className="max-w-2xl text-lg text-muted-foreground">
                                    ...
                                    optimization that delivers measurable
                                    results.
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 w-full">
                                <div className="text-center space-y-4">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        ...
                                        setup, identifying conversion barriers
                                        and opportunities.
                                    </p>
                                </div>
                                ...
                                <div className="text-center space-y-4">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Create a prioritized roadmap based on
                                        impact potential and implementation
                                        complexity.
                                    </p>
                                </div>
                                ...
                                <div className="text-center space-y-4">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        ...
                                        testing to validate each change before
                                        full rollout.
                                    </p>
                                </div>
                        ...
                        <div className="flex flex-col items-center space-y-8 text-center">
                            <div className="space-y-4">
                                ...
                                <p className="max-w-2xl text-lg text-muted-foreground">
                                    ...
                                    identify your biggest conversion
                                    opportunities.
                                </p>
                            </div>
                            <Button
